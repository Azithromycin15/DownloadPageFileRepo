...
(() => {
    ...
    const STEP_DIST = 5;       // 鼠标每移动该距离（px）生成一颗粒子
    const LIFE_MIN = 400;      // 粒子最短寿命（ms）
    const LIFE_MAX = 800;      // 粒子最长寿命（ms）
